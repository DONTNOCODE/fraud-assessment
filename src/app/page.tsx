        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex justify-between items-center">
            ...
            <ul className="hidden md:flex space-x-8">
              ...
              {/* 登录/注册按钮可以放在这里 */}
              {/* <li><button className="px-4 py-2 text-gray-600 hover:text-gray-900">登录</button></li>
              <li><button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">注册</button></li> */} 
            </ul>
            {/* 单独的登录/注册按钮组，保证在右侧 */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[ 
              ...
              <div key={service.title} className="bg-white rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-200 ease-in-out overflow-hidden transform hover:-translate-y-1 border border-gray-100">
                <div className="w-full h-48 bg-gray-200"> {/* Placeholder for image */}
